...
BOOL ChangeSnapshotTypeGUID(HANDLE hSnapshotHandle)
{
	...
	ULONG ulDataLength;
	PBYTE buf;
	GUID gHidden = { 0xe5de7d45, 0x49f2, 0x40a4, {0x81, 0x7c, 0x7d, 0xc8, 0x2b, 0x72, 0x58, 0x7f } }; //{E5DE7D45-49F2-40A4-817C-7DC82B72587F}
...
int _tmain(int argc, _TCHAR** argv, _TCHAR** envp)
{
	...
	if (argc != 2)
	{
		_tprintf(_T("Usage: UnHideSnapshot <Shadow Copy Volume Path>\r\n"));
		return -1;
	}
